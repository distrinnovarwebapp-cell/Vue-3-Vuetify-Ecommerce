...
<template>
  <v-navigation-drawer v-model="drawer" temporary location="left" class="d-md-none bg-pink-lighten-5">
    <v-list class="bg-transparent">
      ...
      <v-list-item prepend-icon="mdi-history" title="Mis Pedidos" @click="goToHistory"></v-list-item>
    </v-list>
  </v-navigation-drawer>

  <v-app-bar elevation="0" class="main-app-bar px-md-4" scroll-behavior="elevate" height="80">
    <v-app-bar-nav-icon class="d-md-none text-brown-darken-2" @click.stop="drawer = !drawer"></v-app-bar-nav-icon>

    <v-app-bar-title class="cursor-pointer logo-wrapper" @click="goHome">
      <div class="d-flex align-center">
        <div class="mr-2">
          <v-avatar size="70">
            <v-img src="/logo-removebg-preview.png" alt="Logo"></v-img>
          </v-avatar>
        </div>
    ...
    <div class="d-flex align-center gap-2">
      <v-btn icon color="brown-darken-1" class="d-none d-sm-flex" @click="goToHistory">
        <v-icon>mdi-history</v-icon>
        <v-tooltip activator="parent" location="bottom">Mis Pedidos</v-tooltip>
      </v-btn>
      ...
      <v-btn @click="goToCart" class="cart-btn text-none px-4 rounded-pill" color="pink-accent-2" variant="flat">
        <v-badge 
